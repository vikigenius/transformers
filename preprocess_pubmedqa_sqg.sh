...
head -n 85000 source > data/pubmedqa_sqg/train.source
head -n 85000 target > data/pubmedqa_sqg/train.target

tail -n 2599 data/pubmedqa_pq_pairs.tsv | awk '!seen[$1]++' > valtest
